...
is assumed or proved here. See Carter, *Simple Groups of Lie Type*, §14.
-/
...
theorem steinberg_eq_specialIsogeny_pow :
  ...
  rw [fieldExponent_eq_one, pow_one, steinberg]
...
@[simp] theorem steinberg_steinberg (g : d.AmbientGroup) :
  ...
  rw [steinberg, frobenius_def, F4ShortRoot.PrimeField.specialIsogeny_specialIsogeny]
