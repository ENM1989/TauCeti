...
simple root.** It reverses the diagram exactly as the half-Frobenius does, its odd power acting on
the parameter by the remaining even power of the characteristic:
