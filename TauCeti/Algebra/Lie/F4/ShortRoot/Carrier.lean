...
the common kernel of the represented simple root subgroups and weight torus.
...
Lie Algebras, Chapters 4--6*, Plate VIII. The formal interface follows the type-`E₇` minuscule
carrier in `TauCeti.Algebra.Lie.E7.Minuscule.Carrier`.
-/
