...
public import TauCeti.Algebra.Lie.F4.ShortRoot.QuotientAction
...
noncomputable def f4ShortRootQuotientFirstColumn
  ...
  f4ShortRootSubspace.mkQ
    ⁅f4ModularRootVector (f4TableSignedSimpleRootIndex k), f4ShortRootQuotientLift a⁆
...
theorem coe_f4ShortRootIdealFirstColumn
  ...
  calc
    ...
    _ = _ := congrArg
      (fun i => ⁅f4ModularRootVector i,
        (f4ShortRootLieIdealBasis a : f4ModularChevalleyLieAlgebra)⁆)
      (f4TableSignedSimpleRootIndex_eq k).symm
...
theorem f4ShortRootQuotientToIdealEquiv_firstColumn_eq_zero_of_short
  ...
  have hzero : f4ShortRootQuotientFirstColumn k a = 0 := by
    exact f4ShortRootSubspace_mkQ_lie_rootVector_eq_zero_of_short
      (f4TableSignedSimpleRootIndex k) hk (f4ShortRootQuotientLift a)
  calc
...
theorem f4SpecialIsogenyIndexEquiv_tableSignedSimpleRootIndex
    (k : Fin 4 ⊕ Fin 4) :
    f4SpecialIsogenyIndexEquiv (f4TableSignedSimpleRootIndex k) =
      f4TableSignedSimpleRootIndex (isogenyReverse k) := by
  rcases k with i | i
  · simp [f4TableSignedSimpleRootIndex, isogenyReverse,
      f4SpecialIsogenyIndexEquiv_apply, f4SpecialIsogenyIndex_castAdd,
      lengthPermF4_apply]
  · have hleft : f4TableSignedSimpleRootIndex (.inr i) =
        (Fin.castAdd 44 i : Fin 48) + 24 := by
      fin_cases i <;> decide +kernel
    have hright : f4TableSignedSimpleRootIndex (isogenyReverse (.inr i)) =
...
theorem f4SpecialIsogenyIndexEquiv_tableOppositeSignedSimpleRootIndex
    (k : Fin 4 ⊕ Fin 4) :
  ...
  rcases k with i | i
  · have hleft : f4TableOppositeSignedSimpleRootIndex (.inl i) =
        (Fin.castAdd 44 i : Fin 48) + 24 := by
      fin_cases i <;> decide +kernel
    have hright : f4TableOppositeSignedSimpleRootIndex (isogenyReverse (.inl i)) =
        (Fin.castAdd 44 i.rev : Fin 48) + 24 := by
      fin_cases i <;> decide +kernel
    rw [hleft, hright, f4SpecialIsogenyIndexEquiv_apply,
      f4SpecialIsogenyIndex_add_twentyFour, f4SpecialIsogenyIndex_castAdd,
      lengthPermF4_apply]
  · simp [f4TableOppositeSignedSimpleRootIndex, isogenyReverse,
      f4SpecialIsogenyIndexEquiv_apply, f4SpecialIsogenyIndex_castAdd,
      lengthPermF4_apply]
...
theorem f4ShortRootQuotientToIdealEquiv_dividedSquare_opposite_of_long
  ...
  have htargetInput : f4TableOppositeSignedSimpleRootIndex (isogenyReverse k) =
      f4SpecialIsogenyIndexEquiv β := by
    simpa only [β] using
      (f4SpecialIsogenyIndexEquiv_tableOppositeSignedSimpleRootIndex k).symm
...
theorem f4ShortRootQuotientToIdealEquiv_dividedSquare_rootColumn_of_long
  ...
  · have hβne : β ≠ f4TableOppositeSignedSimpleRootIndex k := by
      intro h
      apply hi
      apply Subtype.ext
      dsimp only [iopp, β]
      ...
      calc
        ...
        _ = f4SpecialIsogenyIndexEquiv
            (f4TableOppositeSignedSimpleRootIndex k) := congrArg _ h'
    ...
    have htargetShort :
      ...
      have hlen : ∀ l : Fin 4 ⊕ Fin 4,
          f4Length (f4TableSignedSimpleRootIndex l) = 2 →
            f4Length (f4TableSignedSimpleRootIndex (isogenyReverse l)) = 1 := by
        intro l
        rw [f4Length_def]
        revert l
        decide +kernel
    ...
    have htargetNe : i ≠
      ...
      rw [h, f4SpecialIsogenyIndexEquiv_tableOppositeSignedSimpleRootIndex]
...
theorem f4ShortRootQuotientToIdealEquiv_dividedSquare_eq_firstColumn_of_specialMap_add
  ...
  have hideal : f4ShortRootIdealFirstColumn (isogenyReverse k) a =
    ...
    have hsigned : f4SignedSimpleRootIndex (isogenyReverse k) =
      ...
      rw [← f4TableSignedSimpleRootIndex_eq, htargetSource]
...
private theorem f4ShortRootIdealFirstColumn_eq_zero_of_no_short_edge
    ...
    (hα : f4Length (f4TableSignedSimpleRootIndex k) = 2)
    (hβ : f4Length β = 1)
  ...
  calc
    ...
    _ = ⁅f4ModularRootVector α, f4ModularRootVector β⁆ := by
      rw [← f4TableSignedSimpleRootIndex_eq,
...
theorem f4ShortRootQuotientToIdealEquiv_dividedSquare_rootColumn_of_short
  ...
  have htargetSource : f4TableSignedSimpleRootIndex (isogenyReverse k) =
      f4SpecialIsogenyIndexEquiv (f4TableSignedSimpleRootIndex k) :=
    (f4SpecialIsogenyIndexEquiv_tableSignedSimpleRootIndex k).symm
  have htargetLong : f4Length (f4TableSignedSimpleRootIndex (isogenyReverse k)) = 2 := by
    rw [htargetSource]
    simpa only [f4SpecialIsogenyIndexEquiv_apply] using
      (f4Length_specialIsogenyIndex_eq_two_iff
        (f4TableSignedSimpleRootIndex k)).2 hk
  ...
  · have hopp : β ≠ f4TableOppositeSignedSimpleRootIndex k := by
      intro heq
      have hlen := congrArg f4Length heq
      rw [hβ, f4TableOppositeSignedSimpleRootIndex_eq,
        f4Length_opposite, hk] at hlen
      omega
    have hqzero : f4ShortRootQuotientDividedSquareColumn k
        (f4ShortRootWeightIndexEquiv.symm (Sum.inl i)) = 0 := by
      unfold f4ShortRootQuotientDividedSquareColumn
...
private theorem f4ShortRootIdealFirstColumn_cartan_eq_zero_of_short
    (k : Fin 4 ⊕ Fin 4) (hk : f4Length (f4TableSignedSimpleRootIndex k) = 1)
    (j s : Fin 4) (a : Fin 26)
    ...
    _ = ⁅f4ModularRootVector α',
      ...
      exact congrArg₂ (fun x y : f4ModularChevalleyLieAlgebra => ⁅x, y⁆)
        (congrArg f4ModularRootVector
          (f4TableSignedSimpleRootIndex_eq (isogenyReverse k)).symm) ha
